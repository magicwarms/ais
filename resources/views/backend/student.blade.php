...
<div class="uk-width-medium-1-1">
	<h4 class="heading_a uk-margin-bottom">Buat Data Murid Baru</h4>
	<div class="md-card">
	  <div class="md-card-content">
	    <ul class="uk-tab uk-tab-grid" data-uk-tab="{connect:'#tabs_4'}">
        <li class="uk-width-1-2" id="list-tab"><a href="#" class="list_student">List Murid</a></li>
        <li class="uk-width-1-2" id="form-tab"><a href="#" class="form_student">Form Murid</a></li>
	    </ul>
        ...
        <form class="form_input_student" name="formstudent" id="form_validation" enctype="multipart/form-data">
          <input type="hidden" name="id" id="id">
          <input type="hidden" name="method" id="method" value="POST">
          <div class="uk-grid" data-uk-grid-margin>
            <div class="uk-width-medium-1-1">
              <div class="md-card">
                <div class="md-card-content" id="profile_picture_student">
          ...
          <div class="uk-grid" data-uk-grid-margin>
            ...
            <div class="uk-width-medium-1-4 uk-margin-top">
              <label>NIS</label>
              <br>
              <input type="text" id="nis" class="md-input label-fixed" name="nis" required/>
            </div>
            <div class="uk-width-medium-1-4 uk-margin-top">
              <div class="uk-input-group">
                ...
                <br>
                <input class="md-input" id="birthday" type="text" name="birthday" data-uk-datepicker="{pos:'bottom', format:'DD.MM.YYYY'}">
              </div>
            </div>
            <div class="uk-width-medium-1-4 uk-margin-top">
          ...
          <div class="uk-grid" data-uk-grid-margin>
            ...
            <div class="uk-width-medium-1-4 uk-margin-top">
              ...
              <br>
              {{ Form::select('parents_id', $parents, null, array('class' =>'md-input', 'placeholder' => 'Pilih Orang Tua', 'id' => 'parents_id','required')) }}
            </div>
            <div class="uk-width-medium-1-4 uk-margin-top">
              <label>Kelamin</label>
              <br>
            ...
            <div class="uk-width-medium-1-4 uk-margin-top">
              <div class="parsley-row">
                <input class="status_student" type="checkbox" name="status">
                <label for="switch_demo_large" class="inline-label"><b>Aktifkan Siswa</b></label>
              </div>
            </div>
          </div>
          <div class="uk-grid" data-uk-grid-margin>
...
@section('js')
    ...
    <div class="uk-modal" id="studentID">
    ...
    <script type="text/javascript">
        ...
        $(".change_password").click(function(event) {
          $.ajax({
            ...
            url: "{{ route('student.change.password') }}",
        ...
        $(".form_input_student").on('submit',function() {
          var method = $('input#method').val();
          var url_action;
          if(method == 'POST'){
            url_action = "{{ route('student.store') }}";
          } else {
            url_action = "{{ route('student.update') }}";
          }
          $.ajax({
            type: 'POST',
            headers: {
            ...
            success: function(result) {
              ...
              $("#profile_picture_student").html('<input type="file" id="photo_file" class="md-input" name="photo_file" accept="image/png, image/jpg, image/jpeg">')
              $('input#method').val('POST');
              $("#student_password").show();
              $('.form_input_student')[0].reset();
              $('#data_table').DataTable().ajax.reload();
              altair_helpers.content_preloader_hide();
              $("#form-tab").removeClass("uk-active")
              $('.list_student')[0].click();
          ...
          UIkit.modal.confirm("Apakah kamu yakin akan mengubah data ini?", function(){
            ...
            $.ajax({
              ...
              success:function(data) {
                ...
                if(data.photo_file != ''){
                  $("#profile_picture_student").html('<div class="uk-margin-bottom uk-text-center uk-position-relative"><a href="#" class="uk-modal-close uk-close uk-close-alt uk-position-absolute" onclick="delete_photo_file_student('+id+')"></a><img src="storage/'+data.photo_file+'" alt="'+data.name+'" class="img_medium"/></div>')
                } else {
                  $("#profile_picture_student").html('<input type="file" id="photo_file" class="md-input" name="photo_file" accept="image/png, image/jpg, image/jpeg">')
                }
      ...
      function delete_photo_file_student(teacher_id){
        var APP_URL = {!! json_encode(url('/')) !!}
        $.ajax({
            method: 'GET',
            headers: {
            ...
            url: APP_URL + "/student/delete_profile_picture/"+teacher_id,
            dataType: 'JSON',
            cache: false,
            beforeSend: function(){
                altair_helpers.content_preloader_show('md');
