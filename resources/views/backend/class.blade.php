...
<div class="uk-width-medium-1-1">
	<h4 class="heading_a uk-margin-bottom">Buat Data Kelas Baru</h4>
	<div class="md-card">
	  <div class="md-card-content">
	    <ul class="uk-tab uk-tab-grid" data-uk-tab="{connect:'#tabs_4'}">
	      <li class="uk-width-1-2" id="list-tab"><a href="#" class="list_class">List Kelas</a></li>
	      <li class="uk-width-1-2" id="form-tab"><a href="#" class="form_class">Form Kelas</a></li>
	    </ul>
        ...
        <form class="form_input_class" name="formclass" id="form_validation">
          ...
          <div class="uk-grid" data-uk-grid-margin>
            ...
            <div class="uk-width-medium-1-3 uk-margin-top">
              <div class="parsley-row">
                <input class="status_class" type="checkbox" name="status">
                <label for="switch_demo_large" class="inline-label"><b>Aktifkan Kelas</b></label>
              </div>
            </div>
          </div>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        $(".form_input_class").on('submit',function() {
          ...
          var url_action;
          if(method == 'POST'){
            url_action = "{{ route('class.store') }}";
          } else {
            url_action = "{{ route('class.update') }}";
          }
          $.ajax({
            type: method,
            headers: {
          ...
          UIkit.modal.confirm("Apakah kamu yakin akan mengubah data ini?", function(){
            ...
            $.ajax({
              ...
              success:function(data) {
                ...
                $('.status_class')[0].checked = data.status;
                altair_helpers.content_preloader_hide();
              }
            }) 
          });
