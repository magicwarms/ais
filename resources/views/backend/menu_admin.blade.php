...
<div class="uk-width-medium-1-1">
	<h4 class="heading_a uk-margin-bottom">Buat Data Menu Baru</h4>
	<div class="md-card">
	  <div class="md-card-content">
	    <ul class="uk-tab uk-tab-grid" data-uk-tab="{connect:'#tabs_4'}">
	      <li class="uk-width-1-2" id="list-tab"><a href="#" class="list_menu">List Menu</a></li>
	      <li class="uk-width-1-2" id="form-tab"><a href="#" class="form_menu">Form Menu</a></li>
	    </ul>
        ...
        <form class="form_input_menu" name="formmenu" id="form_validation">
          ...
          <div class="uk-grid" data-uk-grid-margin>
            ...
            <div class="uk-width-medium-1-5 uk-margin-top">
              ...
              <br>
              <input type="text" id="icon" class="md-input label-fixed" name="icon" required/>
            </div>
            <div class="uk-width-medium-1-5 uk-margin-top">
              <label>Fungsi Menu</label>
              <br>
              <input type="text" id="function" class="md-input label-fixed" name="function" required/>
            </div>
            <div class="uk-width-medium-1-5 uk-margin-top">
              <div class="parsley-row">
                <label>Parent Menu</label>
                <br>
                {{ Form::select('parent', $parents, null, array('class' =>'md-input', 'placeholder' => 'Menu Parent', 'id' => 'parent')) }}
              </div>
            </div>
            <div class="uk-width-medium-1-5 uk-margin-top">
              <div class="parsley-row">
                <input class="status_menu" type="checkbox" name="status">
...
@section('js')
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        $(".form_input_menu").on('submit',function() {
          var method = $('input#method').val();
          var url_action;
          if(method == 'POST'){
            url_action = "{{ route('menu.store') }}";
          } else {
            url_action = "{{ route('menu.update') }}";
          }
          $.ajax({
            type: method,
            headers: {
          ...
          UIkit.modal.confirm("Apakah kamu yakin akan mengubah data ini?", function(){
            ...
            $.ajax({
              ...
              success:function(data) {
                ...
                $('input#function').val(data.function);
                $('select#parent').val(data.parent);
                $('.status_menu')[0].checked = data.status;
                altair_helpers.content_preloader_hide();
              }
            }) 
          });
