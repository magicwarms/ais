                                ...
                                <div id="login_form">
                                    ...
                                    <form method="POST" action="{{ route('teacher.login') }}">
                                        ...
                                        <div class="uk-form-row">
                                            ...
                                            <input class="md-input" type="text" name="code" required value="{{ old('code') }}" />
                                        </div>
                                        @if($errors->has('code'))
                                            <p class="uk-text-danger">{{ $errors->first('code') }}</p>
                                        @endif
                                        <div class="uk-form-row">
                                        ...
                                        <div class="uk-grid uk-grid-width-1-1 uk-grid-small uk-margin-top" data-uk-grid-margin>
                                            <div>
                                                <a href="{{ route('login') }}" class="md-btn md-btn-block md-btn-facebook" data-uk-tooltip="{pos:'bottom'}" title="Login Administrator"><i class="material-icons uk-margin-remove">account_box</i></a>
                                            </div>
                                        </div>
